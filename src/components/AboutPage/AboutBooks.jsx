        ...
        <div
          ...
          <div className={cl.bookdiv}>
            ...
            <div className={cl.booktext}>
              {" "}
              <p>
                This page will help you remember a new phrase or word using the
                90 seconds technique.
              </p>
              <p>
                You just need to add sentences to memorize to your list and read
                this phrase according to the schedule.
              </p>
            </div>
          </div>
        </div>
        <div
          ...
          <div className={cl.bookdiv}>
            ...
            <div className={cl.booktext}>
              ...
              <p>
                In this way, you will get a ton of useful details (prepositions,
                articles, expression order, and so on), and most importantly,
                you will be able to say the phrase when you need it.
              </p>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          <div className={cl.bookdiv}>
            ...
            <div className={cl.booktext}>
              ...
              <p>
                Just concentrate on it and try to understand what you are really
                saying.
              </p>
              <p>
                Read an expresiion out loud, emotionally and clearly, with full
                concentration.
              </p>
              <p>
