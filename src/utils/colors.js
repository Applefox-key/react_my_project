...
export const themeArr = {
  clean: {
    ...
    "--background-sidebar": "#c8ccd4",
    "--background-card": "#ffffff",
    "--background-label": "#c8ccd4",
    "--background-menu": "#ededed",
    "--background-info": "#f9f3f3",
    "--background-marker": "#fff3cd",
    "--color-marker": "#45474a",
    "--color-label": "#3c3b3bff",
    "--color-sidebar": "#444444",
    "--color-info": "#444444",
    "--color-card": "#444444",
    "--color-menu": "#444444",
    "--color-base": "#444444",
    "--background-color-opacity50": "rgba(237, 237, 237, 0.5)",
  },
  sky: {
  ...
  jade: {
    ...
    "--background-marker": "darkslategray",
    "--color-marker": "#03FDCE",
    "--color-label": "white",
    "--color-sidebar": "white",
    "--color-info": "#026C71",
